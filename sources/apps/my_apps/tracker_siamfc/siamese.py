...
from crops import extract_crops_z, extract_crops_x, pad_frame, gen_xz
...
class SiameseNet(nn.Module):
    ...
    def get_scores_new(self, pos_x, pos_y, scaled_search_area, template_z, image,
