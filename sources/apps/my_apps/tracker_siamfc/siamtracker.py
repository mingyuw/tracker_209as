...
class SiamTracker(object):
    ...
    def __init__(self, image_in, region):
        ...
        image_, self.templates_z_ = self.siam.get_template_z_new(self.pos_x, self.pos_y, self.z_sz, image_in, self.design)

    def track(self, image_in):
        ...
        image_, scores_ = self.siam.get_scores_new(self.pos_x, self.pos_y, scaled_search_area, self.templates_z_, image_in, self.design, self.final_score_sz)
